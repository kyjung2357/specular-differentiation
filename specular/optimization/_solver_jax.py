...
def _vector_jax(
    ...
    """
    Vector implementation of the JAX optimization solver.
    The specular gradient method in the n-dimensional case.
    """
    def body_fun(carry, _):
        x, k, active = carry
        
        specular_gradient = jax_gradient(f, x, h=h, zero_tol=zero_tol)
...
def _vector_stochastic_jax(
    ...
    """
    Vector implementation of the stochastic JAX optimization solver.
    ...
    def body_fun(carry, _):
        ...
        specular_gradient = jax_gradient(f_comp, x, h=h, zero_tol=zero_tol)
        norm = jnp.linalg.norm(specular_gradient)
