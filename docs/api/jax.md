...
* [`docs/api/jax_example.py`](https://github.com/kyjung2357/specular-differentiation/blob/main/docs/api/jax_example.py): A basic implementation using the JAX backend.
