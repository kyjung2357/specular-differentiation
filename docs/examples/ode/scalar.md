...
!!! info paper "Paper"
    ...
    --8<-- "README.md:ref-ellipse-ode"

This page reproduces the numerical experiments in the paper using `specular`.
The six scripts save their canonical PDF figures under `examples/ode/figures/`.
...
[Python source](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/ellipse_exactness.py)
· [PDF figure](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/figures/ellipse_exactness.pdf)
...
[Python source](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/inverse_equation_small_scale.py)
· [PDF figure](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/figures/inverse_equation_small_scale.pdf)
...
[Python source](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/pendulum_fourth_order.py)
· [PDF figure](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/figures/pendulum_fourth_order.pdf)
...
[Python source](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/quadratic_decay_defect_cancellation.py)
· [PDF figure](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/figures/quadratic_decay_defect_cancellation.pdf)
...
[Python source](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/quadratic_decay_convergence.py)
· [PDF figure](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/figures/quadratic_decay_convergence.pdf)
...
[Python source](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/autonomous_large_scale.py)
· [PDF figure](https://github.com/kyjung2357/specular-differentiation/blob/v1.3.0/examples/ode/figures/autonomous_large_scale.pdf)
